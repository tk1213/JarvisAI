...
class SmartHomeService:
    ...
    async def get_device(
        ...
        return await self._adapter.get_device(device_id)

    async def turn_on(
        self,
        device_id: str,
    ) -> bool:
        return await self._adapter.turn_on(device_id)

    async def turn_off(
        self,
        device_id: str,
    ) -> bool:
        return await self._adapter.turn_off(device_id)

    async def toggle(
        self,
        device_id: str,
    ) -> bool:
        return await self._adapter.toggle(device_id)